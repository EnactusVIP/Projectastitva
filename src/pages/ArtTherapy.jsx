...
export default function ArtTherapy({ onNavigate }) {
  ...
  useEffect(() => {
    ...
    const t6 = setTimeout(() => setStage(6), 2000); // Secondary / hover detail
            ...
            >
              <defs>
                <linearGradient id="artStrokeGrad" x1="0%" y1="50%" x2="100%" y2="50%">
                  ...
                  <stop offset="20%" stopColor="#facc15" stopOpacity="0.45" />
                  <stop offset="55%" stopColor="#ffffff" stopOpacity="0.25" />
                  <stop offset="85%" stopColor="#facc15" stopOpacity="0.4" />
